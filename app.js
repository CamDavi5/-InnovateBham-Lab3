...
function checkWinner() {
    ...
    if (turn == 9 && winner == false) {
        console.log("The game is a TIE! Please click again to reset...");
    }
}
...
function checkRowColumn(c1, c2, c3) {
    if (cells[c1].textContent == 'X' && cells[c2].textContent == 'X' && cells[c3].textContent == 'X') {
        console.log("PLAYER 1 IS THE WINNER! Good Game! Please click again to reset...")
        winner = true;
    } else if (cells[c1].textContent == 'O' && cells[c2].textContent == 'O' && cells[c3].textContent == 'O') {
        console.log("PLAYER 2 IS THE WINNER! Good Game! Please click again to reset...")
        winner = true;
    }
}
